import { AnimatableColor, OptionsColor, ValueWithRandom, Vector, arrayRandomIndex, calcPositionOrRandomFromSize, calcPositionOrRandomFromSizeRanged, deepExtend, executeOnSingleOrMultiple, getDistance, getDistances, getRandom, getRangeValue, getSize, getStyleFromHsl, getStyleFromRgb, getValue, isArray, isInArray, isNumber, isPointInside, itemFromArray, itemFromSingleOrMultiple, loadParticlesOptions, randomInRange, rangeColorToHsl, rangeColorToRgb, setRangeValue } from "./esm-D2T_vPGo.js";
import { ExternalInteractorBase, loadSlim } from "./esm-BXkBHttS.js";

//#region node_modules/tsparticles-plugin-absorbers/esm/Options/Classes/AbsorberSizeLimit.js
...
//#endregion
//#region node_modules/tsparticles-plugin-absorbers/esm/Options/Classes/AbsorberSize.js
...
//#endregion
//#region node_modules/tsparticles-plugin-absorbers/esm/Options/Classes/Absorber.js
var Absorber = class {
	constructor() {
...
//#endregion
//#region node_modules/tsparticles-plugin-absorbers/esm/AbsorberInstance.js
var AbsorberInstance = class {
	constructor(absorbers, container, options, position) {
		...
		this._updateParticlePosition = (particle, v) => {
			...
			const container$1 = this.container, canvasSize = container$1.canvas.size;
			...
			if (this.options.orbits) {
				...
				if (particle.absorberOrbit.length <= this.size && !this.options.destroy) {
					...
					particle.absorberOrbit.length = minSize * (1 + (getRandom() * .2 - .1));
				}
				if (particle.absorberOrbitDirection === void 0) particle.absorberOrbitDirection = particle.velocity.x >= 0 ? "clockwise" : "counter-clockwise";
				...
				particle.absorberOrbit.angle += (particle.retina.moveSpeed ?? 0) * container$1.retina.pixelRatio / 100 * container$1.retina.reduceFactor;
			} else {
	...
	attract(particle) {
		...
		if (distance < this.size + particle.getRadius()) {
			...
			if (this.size > particle.getRadius() && distance < this.size - particle.getRadius() || particle.absorberOrbit !== void 0 && particle.absorberOrbit.length < 0) if (options.destroy) particle.destroy();
			else {
...
//#endregion
//#region node_modules/tsparticles-plugin-absorbers/esm/Absorbers.js
var Absorbers = class {
	...
	handleClickMode(mode) {
		...
		if (mode === "absorber") {
			const absorbersOptions = itemFromSingleOrMultiple(modeAbsorbers) ?? itemFromSingleOrMultiple(absorberOptions), aPosition = this.container.interactivity.mouse.clickPosition;
...
//#endregion
//#region node_modules/tsparticles-plugin-absorbers/esm/index.js
var AbsorbersPlugin = class {
	...
	needsPlugin(options) {
		...
		else if (options.interactivity?.events?.onClick?.mode && isInArray("absorber", options.interactivity.events.onClick.mode)) return true;
		return false;
	}
};
...
//#endregion
//#region node_modules/tsparticles-updater-destroy/esm/Options/Classes/DestroyBounds.js
...
//#endregion
//#region node_modules/tsparticles-updater-destroy/esm/Options/Classes/SplitFactor.js
...
//#endregion
//#region node_modules/tsparticles-updater-destroy/esm/Options/Classes/SplitRate.js
...
//#endregion
//#region node_modules/tsparticles-updater-destroy/esm/Options/Classes/Split.js
var Split = class {
	constructor() {
		this.count = 1;
...
//#endregion
//#region node_modules/tsparticles-updater-destroy/esm/Options/Classes/Destroy.js
var Destroy = class {
	constructor() {
...
//#endregion
//#region node_modules/tsparticles-updater-destroy/esm/Utils.js
function addSplitParticle(engine, container, parent, splitParticlesOptions) {
	...
	return container.particles.addParticle(position, options, parent.group, (particle) => {
		if (particle.size.value < .5) return false;
...
function split(engine, container, particle) {
	...
	if (splitOptions.count >= 0 && (particle.splitCount === void 0 || particle.splitCount++ > splitOptions.count)) return;
...
//#endregion
//#region node_modules/tsparticles-updater-destroy/esm/DestroyUpdater.js
var DestroyUpdater = class {
	...
	particleDestroyed(particle, override) {
		if (override) return;
		const destroyOptions = particle.options.destroy;
		if (destroyOptions && destroyOptions.mode === "split") split(this.engine, this.container, particle);
	}
	update(particle) {
...
//#endregion
//#region node_modules/tsparticles-updater-destroy/esm/index.js
...
//#endregion
//#region node_modules/tsparticles-plugin-emitters/esm/Shapes/Circle/CircleShape.js
var CircleShape = class {
	randomPosition(position, size, fill) {
		const generateTheta = (x, y) => {
			const u = getRandom() / 4, theta = Math.atan(y / x * Math.tan(2 * Math.PI * u)), v = getRandom();
			if (v < .25) return theta;
			else if (v < .5) return Math.PI - theta;
			else if (v < .75) return Math.PI + theta;
			else return -theta;
...
//#endregion
//#region node_modules/tsparticles-plugin-emitters/esm/Options/Classes/EmitterLife.js
...
//#endregion
//#region node_modules/tsparticles-plugin-emitters/esm/Options/Classes/EmitterRate.js
...
//#endregion
//#region node_modules/tsparticles-plugin-emitters/esm/Options/Classes/EmitterSize.js
...
//#endregion
//#region node_modules/tsparticles-plugin-emitters/esm/Options/Classes/Emitter.js
var Emitter = class {
	constructor() {
		this.autoPlay = true;
		this.fill = true;
	...
	load(data) {
		...
		this.rate.load(data.rate);
		if (data.shape !== void 0) this.shape = data.shape;
		if (data.position !== void 0) {
			this.position = {};
			if (data.position.x !== void 0) this.position.x = setRangeValue(data.position.x);
			if (data.position.y !== void 0) this.position.y = setRangeValue(data.position.y);
...
//#endregion
//#region node_modules/tsparticles-plugin-emitters/esm/EmitterInstance.js
var EmitterInstance = class {
	constructor(engine, emitters, container, options, position) {
		...
		this._emitParticles = (quantity) => {
			const position$1 = this.getPosition(), size = this.getSize(), singleParticlesOptions = itemFromSingleOrMultiple(this._particlesOptions);
			for (let i = 0; i < quantity; i++) {
				const particlesOptions$1 = deepExtend({}, singleParticlesOptions);
				if (this.spawnColor) {
					...
					if (!particlesOptions$1.color) particlesOptions$1.color = { value: this.spawnColor };
					else particlesOptions$1.color.value = this.spawnColor;
				}
				if (!position$1) return;
				const pPosition = this._shape?.randomPosition(position$1, size, this.fill) ?? position$1;
				this.container.particles.addParticle(pPosition, particlesOptions$1);
			}
		};
		this._prepareToDie = () => {
			if (this._paused) return;
			const duration = this.options.life?.duration !== void 0 ? getRangeValue(this.options.life.duration) : void 0;
			if (this.container.retina.reduceFactor && (this._lifeCount > 0 || this._immortal) && duration !== void 0 && duration > 0) this._duration = duration * 1e3;
		};
		this._setColorAnimation = (animation, initValue, maxValue) => {
			const container$1 = this.container;
			if (!animation.enable) return initValue;
			const colorOffset = randomInRange(animation.offset), emitFactor = 1e3 * getRangeValue(this.options.rate.delay) / container$1.retina.reduceFactor, colorSpeed = getRangeValue(animation.speed ?? 0);
			return (initValue + colorSpeed * container$1.fpsLimit / emitFactor + colorOffset * 3.6) % maxValue;
		};
		this._engine = engine;
		...
		if (this.options.spawnColor) this.spawnColor = rangeColorToHsl(this.options.spawnColor);
	...
	play() {
		if (this._paused) return;
		if (!(this.container.retina.reduceFactor && (this._lifeCount > 0 || this._immortal || !this.options.life.count) && (this._firstSpawn || this._currentSpawnDelay >= (this._spawnDelay ?? 0)))) return;
		if (this._emitDelay === void 0) this._emitDelay = 1e3 * getRangeValue(this.options.rate.delay) / this.container.retina.reduceFactor;
		if (this._lifeCount > 0 || this._immortal) this._prepareToDie();
	}
	resize() {
...
//#endregion
//#region node_modules/tsparticles-plugin-emitters/esm/Emitters.js
var Emitters = class {
	constructor(engine, container) {
		this.container = container;
		this._engine = engine;
	...
	async init() {
		...
		if (isArray(this.emitters)) for (const emitterOptions of this.emitters) this.addEmitter(emitterOptions);
...
//#endregion
//#region node_modules/tsparticles-plugin-emitters/esm/ShapeManager.js
...
//#endregion
//#region node_modules/tsparticles-plugin-emitters/esm/Shapes/Square/SquareShape.js
function randomSquareCoordinate(position, offset) {
	return position + offset * (getRandom() - .5);
}
var SquareShape = class {
	randomPosition(position, size, fill) {
		if (fill) return {
			...
			const halfW = size.width / 2, halfH = size.height / 2, side = Math.floor(getRandom() * 4), v = (getRandom() - .5) * 2;
			switch (side) {
				case 0: return {
...
//#endregion
//#region node_modules/tsparticles-plugin-emitters/esm/index.js
var EmittersPlugin = class {
	...
	loadOptions(options, source) {
		...
		if (interactivityEmitters) if (isArray(interactivityEmitters)) options.interactivity.modes.emitters = {
			...
			if (emitterMode.value !== void 0) if (isArray(emitterMode.value)) options.interactivity.modes.emitters = {
				random: {
...
//#endregion
//#region node_modules/tsparticles-interaction-external-trail/esm/Options/Classes/Trail.js
var Trail = class {
	constructor() {
		this.delay = 1;
...
//#endregion
//#region node_modules/tsparticles-interaction-external-trail/esm/TrailMaker.js
...
//#endregion
//#region node_modules/tsparticles-interaction-external-trail/esm/index.js
...
//#endregion
//#region node_modules/tsparticles-updater-roll/esm/Utils.js
function initParticle(particle) {
	...
	if (rollOpt.backColor) particle.backColor = rangeColorToHsl(rollOpt.backColor);
	else if (rollOpt.darken.enable && rollOpt.enlighten.enable) {
		const alterType = getRandom() >= .5 ? "darken" : "enlighten";
		particle.roll.alter = {
			type: alterType,
...
//#endregion
//#region node_modules/tsparticles-updater-roll/esm/Options/Classes/RollLight.js
var RollLight = class {
	constructor() {
		this.enable = false;
		this.value = 0;
...
//#endregion
//#region node_modules/tsparticles-updater-roll/esm/Options/Classes/Roll.js
var Roll = class {
	constructor() {
...
//#endregion
//#region node_modules/tsparticles-updater-roll/esm/RollUpdater.js
...
//#endregion
//#region node_modules/tsparticles-updater-roll/esm/index.js
async function loadRollUpdater(engine, refresh = true) {
	await engine.addParticleUpdater("roll", () => new RollUpdater(), refresh);
}

//#endregion
//#region node_modules/tsparticles-updater-tilt/esm/Options/Classes/TiltAnimation.js
...
//#endregion
//#region node_modules/tsparticles-updater-tilt/esm/Options/Classes/Tilt.js
...
//#endregion
//#region node_modules/tsparticles-updater-tilt/esm/Utils.js
function updateTilt(particle, delta) {
	if (!particle.tilt || !particle.options.tilt) return;
	const tiltAnimation = particle.options.tilt.animation, speed = (particle.tilt.velocity ?? 0) * delta.factor, max = 2 * Math.PI, decay = particle.tilt.decay ?? 1;
	...
	if (particle.tilt.velocity && decay !== 1) particle.tilt.velocity *= decay;
}

//#endregion
//#region node_modules/tsparticles-updater-tilt/esm/TiltUpdater.js
var TiltUpdater = class {
	...
	init(particle) {
		...
		particle.tilt = {
			...
			sinDirection: getRandom() >= .5 ? 1 : -1,
			cosDirection: getRandom() >= .5 ? 1 : -1
		};
		let tiltDirection = tiltOptions.direction;
		if (tiltDirection === "random") tiltDirection = Math.floor(getRandom() * 2) > 0 ? "counter-clockwise" : "clockwise";
...
//#endregion
//#region node_modules/tsparticles-updater-tilt/esm/index.js
...
//#endregion
//#region node_modules/tsparticles-updater-twinkle/esm/Options/Classes/TwinkleValues.js
...
//#endregion
//#region node_modules/tsparticles-updater-twinkle/esm/Options/Classes/Twinkle.js
var Twinkle = class {
	constructor() {
...
//#endregion
//#region node_modules/tsparticles-updater-twinkle/esm/TwinkleUpdater.js
...
//#endregion
//#region node_modules/tsparticles-updater-twinkle/esm/index.js
async function loadTwinkleUpdater(engine, refresh = true) {
	await engine.addParticleUpdater("twinkle", () => new TwinkleUpdater(), refresh);
}

//#endregion
//#region node_modules/tsparticles-updater-wobble/esm/Options/Classes/WobbleSpeed.js
...
//#endregion
//#region node_modules/tsparticles-updater-wobble/esm/Options/Classes/Wobble.js
var Wobble = class {
	constructor() {
		this.distance = 5;
		this.enable = false;
...
//#endregion
//#region node_modules/tsparticles-updater-wobble/esm/Utils.js
function updateWobble(particle, delta) {
	const { wobble: wobbleOptions } = particle.options, { wobble } = particle;
	if (!wobbleOptions?.enable || !wobble) return;
	const angleSpeed = wobble.angleSpeed * delta.factor, distance = wobble.moveSpeed * delta.factor * ((particle.retina.wobbleDistance ?? 0) * delta.factor) / (1e3 / 60), max = 2 * Math.PI, { position } = particle;
...
//#endregion
//#region node_modules/tsparticles-updater-wobble/esm/WobbleUpdater.js
...
//#endregion
//#region node_modules/tsparticles-updater-wobble/esm/index.js
...
//#endregion
//#region node_modules/tsparticles/esm/index.js
